...
// Added static IP of the AWS_IOT_MQTT_HOST when following guide:
// https://labs.mediatek.com/site/global/developer_tools/mediatek_linkit/get-started/aws/create-run/index.gsp
VMSTR IP_ADDRESS = "54.209.1.110";
